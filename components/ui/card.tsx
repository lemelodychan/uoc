  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          '@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start px-4 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-5',
          className,
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn('leading-none font-bold text-lg font-display', className)}
        {...props}
      />
    )
  }
